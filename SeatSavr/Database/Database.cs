...
namespace SeatSavr
{
    public static class Database
    {
        ...
        public static Task<Layout[]> GetAdminLayoutsAsync(string adminEmail)
        {
            ...
            SqliteDataReader sqlite_datareader = ReadFrom(sqlite_conn, $"SELECT * FROM Layout WHERE BuildingAddress = (SELECT BuildingAddress FROM Manages WHERE Email = \'{adminEmail}\');");
            List<Layout> layoutList = new List<Layout>();
